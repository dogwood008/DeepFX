...
USER jovyan
RUN pip install backtrader scipy xgboost TA-Lib pandas gym numpy pandas keras sklearn gym tensorflow google-api-python-client jupyter_contrib_nbextensions
